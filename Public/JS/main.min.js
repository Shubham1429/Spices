                ...
                return e.ajax(
                    {
                        ...
                        success:function(e)
                        {
                            ...
                            i=t.message,
                            s=t.type;
                            "success"===s?(swal("Success",i,"success"),
                            o.reset()):"danger"===s&&swal("pops",i,"error")
                        }
                        ,statusCode:
                        {
                            404:function()
...
catch(e){}}(jQuery);try{wow=new WOW({animateClass:"animated"}),wow.init()}catch(e){}
